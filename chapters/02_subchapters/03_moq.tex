...
is, as of summer 2024, still in the process of standardization by the IETF\@.
...
One is heavily focused on low latency, while the other aims for high scalability.
